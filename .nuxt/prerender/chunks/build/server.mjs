...
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file://C:/xampp82/htdocs/my-portfolio/node_modules/h3/dist/index.mjs';
import { getActiveHead, CapoPlugin } from 'file://C:/xampp82/htdocs/my-portfolio/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/xampp82/htdocs/my-portfolio/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/xampp82/htdocs/my-portfolio/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://C:/xampp82/htdocs/my-portfolio/node_modules/radix3/dist/index.mjs';
import { defu } from 'file://C:/xampp82/htdocs/my-portfolio/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://C:/xampp82/htdocs/my-portfolio/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/xampp82/htdocs/my-portfolio/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-KVWJLvPv.mjs')
  },
  {
    name: "projects-crypto-exchange-platform",
    path: "/projects/crypto-exchange-platform",
    component: () => import('./crypto-exchange-platform-Cwouq9In.mjs')
  },
  {
    name: "projects-e-procurement",
    path: "/projects/e-procurement",
    component: () => import('./e-procurement-DWyCHQb6.mjs')
  },
  {
    name: "projects-jdm-trading",
    path: "/projects/jdm-trading",
    component: () => import('./jdm-trading-DlYnILrz.mjs')
  },
  {
    name: "projects-pluto-pakistan",
    path: "/projects/pluto-pakistan",
    component: () => import('./pluto-pakistan-BU4-TLFE.mjs')
  },
  {
    name: "projects-school-management",
    path: "/projects/school-management",
    component: () => import('./school-management-DZxDYwP7.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DaFPW83N.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-CmwoHMgi.mjs'));
...
export { _export_sfc as _, useRuntimeConfig as a, useRoute as b, resolveRouteObject as c, navigateTo as d, entry$1 as default, useNuxtApp as e, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRouter as u };
