import { ssrRenderStyle, ssrRenderAttr, ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderComponent } from "vue/server-renderer";
import { publicAssetsURL } from "#internal/nuxt/paths";
import { useSSRContext, ref, mergeProps, computed, unref, withCtx, createVNode, toDisplayString } from "vue";
import { _ as _export_sfc, u as useRouter } from "../server.mjs";
import { u as useSwiper } from "./useSwiper.client-DAjSbL4O.js";
import { _ as __nuxt_component_0$2 } from "./nuxt-link-9qLb5Ud6.js";
import "ofetch";
import "hookable";
import "unctx";
import "h3";
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "bg-dark px-3 py-4" }, _attrs))}><h4 class="text-primary text-center"><u>Services</u></h4><h3 class="text-center">What I Do?</h3><div class=""><swiper-container><swiper-slide><div class="text-center service-slide"><img${ssrRenderAttr("src", _imports_0$1)} alt="Vue.js Logo" height="70"><h4 class="mt-3">Vue.js / Nuxt.js</h4><p class="text-light text-opacity-75 mb-2"> Advanced expertise in developing dynamic web applications with Vue.js and Nuxt.js. </p><p class="fw-semibold text-light text-opacity-75"> Vuex · Pinia · iView · Ant Design · BootstrapVue · Laravel Echo · SignalR </p></div></swiper-slide><swiper-slide><div class="text-center service-slide"><div class="position-relative mx-auto" style="${ssrRenderStyle({ "width": "fit-content" })}"><div class="bg-black p-3 laravel-box text-light"><img${ssrRenderAttr("src", _imports_1)} alt="Laravel Logo" height="70"><h4 class="mt-4">Laravel (PHP)</h4><p class="fw-semibold text-opacity-75"><small>Broadcasting · Pusher · Notification · Queue Jobs · Inertia.js · Artisan Commands · Task Scheduling · Seeders · Factories. etc</small></p></div><div class="laravel-triangle"></div></div></div></swiper-slide><swiper-slide><div class="text-center service-slide"><img${ssrRenderAttr("src", _imports_2$1)} alt="AWS Logo" height="70"><h4 class="mt-4">AWS</h4><p class="text-light text-opacity-75 mb-2"> Strong knowledge of AWS services with hands-on experience in deployment and scalability. </p><p class="fw-semibold text-opacity-75"> EC2 · S3 · Route 53 · AWS Amplify · CloudFront · RDS · IAM </p></div></swiper-slide></swiper-container></div></section>`);
    };
  }
};
...
//# sourceMappingURL=index-KVWJLvPv.js.map
